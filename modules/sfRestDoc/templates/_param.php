                    <tr>
                        ...
                        <td class="param-description">
                            <p><?php  echo __($param->getRawValue()->getDescription())?><?php if ($param->getRawValue()->getDefault()):?> ( par défaut : <strong><?php echo $param->getRawValue()->getDefault()?></strong> )<?php endif;?></p>
